...
A Semana OmniStack é um workshop online produzido pela Rocketseat. Esta é a versão 11, onde o [Diego Fernandes](https://github.com/diego3g) nos ensina a desenvolver uma aplicação desde o backend até o frontend web e mobile com uma única linguagem, o Javascript. O nome da aplicação desenvolvida é Be The Hero, uma aplicação para cadastro de ONGs e casos cadastrados por elas para que outras pessoas possam ajudar com doações em dinheiro.

Para clonar o repositório, execute o seguinte comando no terminal:

```git clone https://github.com/DanielM08/Be-The-Hero.git```
...
As rotas para acessar a API estão no arquivo [routes.js](https://github.com/DanielM08/Be-The-Hero/blob/master/backend/src/routes.js). Você pode testar as rotas antes de usar o frontend com o software Insomnia. Você só precisa baixar e instalar o Insomnia na sua máquina, e acessar as rotas da aplicação.

Também foram criados alguns testes na aplicação (Um unitário, e um de integração), que podem ser encontrados na pasta [test](https://github.com/DanielM08/Be-The-Hero/blob/master/backend/test/)
...
![](https://github.com/DanielM08/Be-the-Hero/blob/master/frontend/aplicacao_web.gif)

:iphone:Versão Mobile

![](https://github.com/DanielM08/Be-the-Hero/blob/master/frontend/aplicacao_mobile.gif)
